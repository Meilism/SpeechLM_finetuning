...
# SpeechLM Base model #
# ####################################
[ $# -lt 3 ] && echo "Usage: $0 <model_path> <data_dir> <cpt_tag> <freeze_layers> <speech_subset> [mount=${PWD}] [world_size=8] [update_freq=1]" && exit 1
...
config=speechlm_base_mixed_sa_finetune
